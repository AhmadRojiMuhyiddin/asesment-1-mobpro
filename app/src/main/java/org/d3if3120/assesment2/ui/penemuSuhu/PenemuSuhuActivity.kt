...
import org.d3if3120.assesment2.databinding.PenemuSuhuActivityBinding
import org.d3if3120.assesment2.network.ApiStatus
import org.d3if3120.assesment2.network.ServiceAPI

class PenemuSuhuActivity : AppCompatActivity() {

    private lateinit var binding: PenemuSuhuActivityBinding
    private lateinit var myAdapter: PenemuSuhuAdapter
    private lateinit var viewModel: PenemuSuhuViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = PenemuSuhuActivityBinding.inflate(layoutInflater)
        ...
        ).get(PenemuSuhuViewModel::class.java)
        myAdapter = PenemuSuhuAdapter()

        binding.recyclerView.apply {
            layoutManager = LinearLayoutManager(this@PenemuSuhuActivity)
